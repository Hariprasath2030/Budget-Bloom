...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-100">
      ...
      <div className="relative mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:items-center lg:h-screen">
        {/* Text */}
        <motion.div
        ...
        >
          ...
          <p className="mt-6 text-gray-600 sm:text-lg">
            Track expenses, manage income, and unlock insights into your
            spending habits — all in one clean, powerful dashboard.
          </p>

          <div className="mt-10 flex justify-center gap-4">
            <a
              href="/sign-in"
              className="group relative inline-flex items-center justify-center rounded-xl bg-blue-600 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all hover:bg-black"
            >
              Get Started 🚀
              <span className="absolute inset-0 rounded-xl ring-2 ring-blue-400 opacity-0 group-hover:opacity-100 transition" />
            </a>
          </div>
        </motion.div>
      </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left dark:text-gray-400">
                Take control of your finances with our Budget Bloom. Easily
                monitor your spending, set budgets, and gain insights into your
                financial habits. Stay on top of your expenses and make informed
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
              ...
              <div className="text-center sm:text-left">
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <span className="text-lg flex-1 text-gray-700 dark:text-gray-300">
                    Developed By Hariprasath V
                  </span>
                  <li>
                    <br></br>
                    <a
