...
export default function BudgetItem({ budget }) {
  ...
  return (
    <Link href={"/dashboard/expenses/" + budget?.id}>
      <div className="overflow-hidden p-5 border border-gray-200 rounded-xl hover:shadow-lg cursor-pointer h-[auto] bg-gradient-to-br from-white to-gray-50 hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 transform hover:-translate-y-1 mb-5">
        <div className="flex gap-2 items-center justify-between">
          <div className="flex gap-2 items-center">
            <h2 className="text-2xl p-3 px-4 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-full border border-blue-200">
              {budget?.icon}
            </h2>
            <div>
