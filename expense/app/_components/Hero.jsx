        ...
        <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
              ...
              <div className="text-center sm:text-left">
                <p className="text-lg font-medium text-gray-900 dark:text-white">Expense Categories</p>
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    <a
                      className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
                ...
                <ul className="mt-8 space-y-4 text-sm">
                  <li>
                    ...
                    >
                      ...
                      <span className="flex-1 text-gray-700 dark:text-gray-300">officialhari2030.gmail.com </span>
                    </a>
                  </li>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span className="flex-1 text-gray-700 dark:text-gray-300">8925425514</span>
                    </a>
                  </li>
